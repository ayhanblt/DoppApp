...
export const seedRestaurants: Restaurant[] = [
  {
    ...
    menu: [
      { id: "crispy-half", name: { tr: "Çıtır Yarım Yarım Tavuk", en: "Crispy Half & Half Chicken" }, description: { tr: "Sade ve soslu çift lezzet", en: "Plain and sauced double flavor" }, price: 650, calories: 1800, image: img("c1.png"), optionGroups },
      { id: "soy-boneless", name: { tr: "Kemiksiz Soya Tavuk", en: "Boneless Soy Chicken" }, description: { tr: "Tatlı tuzlu imza sos", en: "Sweet-savory signature sauce" }, price: 590, calories: 1650, image: img("c2.png"), optionGroups },
  ...
  },
  {
    ...
    menu: [
      { id: "tonkotsu", name: { tr: "Tonkotsu Ramen", en: "Tonkotsu Ramen" }, description: { tr: "12 saat kaynamış yoğun et suyu", en: "Rich broth simmered for 12 hours" }, price: 330, calories: 750, image: img("r1.png"), optionGroups },
      { id: "miso", name: { tr: "Acılı Miso Ramen", en: "Spicy Miso Ramen" }, description: { tr: "Baharatlı miso tabanı", en: "Spicy miso base" }, price: 360, calories: 820, image: img("r2.png"), optionGroups },
      { id: "karaage", name: { tr: "Karaage", en: "Karaage" }, description: { tr: "6 parça çıtır tavuk", en: "Six crispy chicken bites" }, price: 195, calories: 480, image: img("r3.png"), optionGroups }
    ]
  },
  {
    id: "pasta-lab",
    ...
    menu: [
      { id: "rose-shrimp", name: { tr: "Karidesli Rose Makarna", en: "Shrimp Rose Pasta" }, description: { tr: "Yumuşak rose sos", en: "Creamy rose sauce" }, price: 445, calories: 680, image: img("p1.png"), optionGroups },
      { id: "vongole", name: { tr: "Vongole Yağlı Makarna", en: "Vongole Oil Pasta" }, description: { tr: "Deniz kokulu hafif tabak", en: "Light coastal plate" }, price: 415, calories: 620, image: img("p2.jpg"), optionGroups },
  ...
  },
  {
    ...
    menu: [
      { id: "salmon-poke", name: { tr: "Somon Poke Bowl", en: "Salmon Poke Bowl" }, description: { tr: "Somon, avokado ve taze yeşillik", en: "Salmon, avocado, fresh greens" }, price: 405, calories: 520, image: img("g1.jpg"), optionGroups },
      { id: "chicken-poke", name: { tr: "Tavuklu Poke Bowl", en: "Chicken Poke Bowl" }, description: { tr: "Protein dolu hafif öğün", en: "A protein-rich light meal" }, price: 355, calories: 430, image: img("g2.jpg"), optionGroups },
  ...
  },
  {
    ...
    menu: [
      { id: "kimchi", name: { tr: "Kimchi Güveç", en: "Kimchi Stew" }, description: { tr: "Derin, ekşi ve sıcak", en: "Deep, tangy, and warm" }, price: 285, calories: 550, image: img("h1.jpg"), optionGroups },
      { id: "bibimbap", name: { tr: "Taş Kase Bibimbap", en: "Stone Bowl Bibimbap" }, description: { tr: "Çıtır pirinç tabanı", en: "Crispy rice base" }, price: 330, calories: 620, image: img("h2.jpg"), optionGroups },
      { id: "pork-set", name: { tr: "Baharatlı Et Seti", en: "Spicy Stir-fry Set" }, description: { tr: "Acı tatlı doyurucu set", en: "Sweet-spicy hearty set" }, price: 360, calories: 700, image: img("h3.jpg"), optionGroups }
    ]
  },
  {
    id: "burger-factory",
    ...
    menu: [
      { id: "smash", name: { tr: "Smash Burger", en: "Smash Burger" }, description: { tr: "Çift köfte ve eritilmiş cheddar", en: "Double patty and melted cheddar" }, price: 390, calories: 920, image: img("bg1.jpg"), optionGroups },
  ...
  },
  {
    ...
    menu: [
      { id: "noodle", name: { tr: "Soya Soslu Noodle", en: "Soy Sauce Noodles" }, description: { tr: "Wok ateşinde sebzeli noodle", en: "Wok-fired vegetable noodles" }, price: 225, calories: 680, image: img("cn1.jpg"), optionGroups },
      { id: "sweet-sour", name: { tr: "Tatlı Ekşi Tavuk", en: "Sweet Sour Chicken" }, description: { tr: "Çıtır kaplama ve parlak sos", en: "Crispy coating and glossy sauce" }, price: 570, calories: 1200, image: img("cn2.jpg"), optionGroups }
    ]
  },
  {
    id: "spicy-tteok",
    ...
    menu: [
      { id: "rose-tteok", name: { tr: "Rose Tteokbokki", en: "Rose Tteokbokki" }, description: { tr: "Kremalı baharatlı pirinç keki", en: "Creamy spicy rice cakes" }, price: 240, calories: 580, image: img("b1.jpg"), optionGroups },
      { id: "fried-set", name: { tr: "Karışık Kızartma", en: "Mixed Fry Set" }, description: { tr: "Sebze, karides ve çıtır rulolar", en: "Vegetable, shrimp, and crispy rolls" }, price: 135, calories: 380, image: img("b3.jpg"), optionGroups }
    ]
  },
  {
    id: "sweet-roastery",
    ...
    menu: [
      { id: "americano", name: { tr: "Buzlu Americano", en: "Iced Americano" }, description: { tr: "Düşük asiditeli harman", en: "Low-acid house blend" }, price: 135, calories: 10, image: img("cf1.jpg"), optionGroups },
      { id: "strawberry-cake", name: { tr: "Çilekli Pasta", en: "Strawberry Cream Cake" }, description: { tr: "İki kat yumuşak kek", en: "Soft two-layer sponge" }, price: 235, calories: 450, image: img("cf2.jpg"), optionGroups }
    ]
  },
  {
    id: "mala-house",
    ...
    menu: [
      { id: "mala-tang", name: { tr: "Mala Tang", en: "Mala Tang" }, description: { tr: "Kendi malzemeni seçtiğin acı çorba", en: "Spicy soup with chosen ingredients" }, price: 390, calories: 750, image: img("ml1.jpg"), optionGroups },
      { id: "mala-xiang", name: { tr: "Mala Xiang Guo", en: "Mala Xiang Guo" }, description: { tr: "Tavada yoğun baharat", en: "Stir-fried deep spice" }, price: 480, calories: 920, image: img("ml2.jpg"), optionGroups }
    ]
  },
  {
    ...
    menu: [
      { id: "pint", name: { tr: "Pint Dondurma", en: "Ice Cream Pint" }, description: { tr: "İki lezzet seçilebilir", en: "Choose two flavors" }, price: 270, calories: 520, image: img("ic1.jpg"), optionGroups },
      { id: "ice-cake", name: { tr: "Dondurma Pastası", en: "Ice Cream Cake" }, description: { tr: "Çikolata ve vanilya katları", en: "Chocolate and vanilla layers" }, price: 780, calories: 1200, image: img("ic2.jpg"), optionGroups }
    ]
  },
  {
    id: "pretty-gopchang",
    ...
    menu: [
      { id: "veg-gop", name: { tr: "Sebzeli Gopchang", en: "Vegetable Gopchang" }, description: { tr: "Sebzeli sıcak tava", en: "Hot pan with vegetables" }, price: 420, calories: 420, image: img("gp1.jpg"), optionGroups },
      { id: "makchang", name: { tr: "Baharatlı Makchang", en: "Spicy Makchang" }, description: { tr: "Tatlı acı ızgara", en: "Sweet-spicy grill" }, price: 450, calories: 510, image: img("gp3.jpg"), optionGroups }
    ]
  },
  {
    id: "sushi-hiro",
  ...
  },
  {
    ...
    menu: [
      { id: "single-tteok", name: { tr: "Tek Kişilik Tteokbokki", en: "Single Tteokbokki" }, description: { tr: "Bağımlılık yapan acı tatlı sos", en: "Addictive sweet-spicy sauce" }, price: 300, calories: 620, image: img("b1.jpg"), optionGroups },
