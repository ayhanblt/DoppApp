...
export function ShareReceiptIcon({ size = 64, color = "currentColor", ...props }: SvgProps & { size?: number | string }) {
  return (
    <Svg
      width={size}
      height={size}
